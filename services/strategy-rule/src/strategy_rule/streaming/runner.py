...
from strategy_rule.clients.pubsub import PubSubPublisher, PubSubSubscriber, PulledMessage
...
class StreamRunner:
    """`processed-features` を pull し、戦略を評価して `strategy-signals-a` に
    publish しつつ Supabase `strategy_logs` に書き込む中核ループ。
