...
Phase 1 only wires up a `--help`-able stub; backtest / stream subcommands arrive
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.mode is None:
        ...
        return 0
    print(
        f"aggregator mode '{args.mode}' is not implemented yet (Phase 1 ships consensus only).",
        file=sys.stderr,
    )
    return 2
