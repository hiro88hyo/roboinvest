...
class PubSubPublisher:
    """Pub/Sub REST publisher.

    When `emulator_host` is non-empty, talks to the local emulator with
    no auth. Production use requires injecting a Bearer token (not yet
    implemented — feeder/feature-engine/strategy-rule carry the same TODO).
    """
