...
| --- | --- | --- |
| `NEXT_PUBLIC_SUPABASE_URL` | `op://Trade AI/production/SUPABASE_URL` | Browser + Server |
| `NEXT_PUBLIC_SUPABASE_ANON_KEY` | `op://Trade AI/production/SUPABASE_ANON_KEY` | Browser + Server |
| `SUPABASE_SECRET_KEY` | `op://Trade AI/production/SUPABASE_SECRET_KEY` | Server only |
